...
public class MultiProcedureCall<T, R> extends AbstractProcedureCall<T, R> {
  ...
  public MultiProcedureCall(Collection<? extends Server> servers, Procedure<T, R> procedure, T argument, long maxTimeout) {
    ...
    for (Server server : Sets.newHashSet(servers)) {
