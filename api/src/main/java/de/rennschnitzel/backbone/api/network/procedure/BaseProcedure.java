...
public class BaseProcedure<T, R> implements Procedure<T, R> {
  ...
  @Override
  public boolean isApplicable(NetworkProtocol.ProcedureMessage procedure) {
    boolean result = true;
  ...
  protected final void validate(NetworkProtocol.ProcedureMessage procedure) throws IllegalArgumentException {
