...
public class CircularByteBuffer {
	...
	protected class CircularByteBufferOutputStream extends OutputStream {
		 ...
		 *             if buffer does not allow blocking writes and the buffer is full. If the exception is thrown, no
		 *             data will have been written since the buffer was set to be non-blocking.
		 * @throws IOException
		 ...
		 * @throws BufferOverflowException
		 *             if buffer does not allow blocking writes and the buffer is full.
		 * @throws IOException
		 *             if the stream is closed, or the write is interrupted.
		 *
		 * @since ostermillerutils 1.00.00
