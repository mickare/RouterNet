...
public @Getter class Target {
	...
	public Target( boolean toAll, Collection<UUID> nodesInclude, Collection<UUID> nodesExclude, Collection<String> namespacesInclude, Collection<String> namespacesExclude ) {
		this.toAll = toAll;
