...
public abstract class AbstractSubTunnelDescriptor<SELF extends AbstractSubTunnelDescriptor<SELF, C>, C extends AbstractSubTunnel<C, SELF>> implements SubTunnelDescriptor<C> {
